...
bool MyApp::OnInit()
{
    ...
    TaskMgr::addTask("ReadImage",(TASKENTRY_VOIDPTR)readImage);
    TaskMgr::addTask("WriteImage",(TASKENTRY_VOIDPTR)writeImage);

    TaskMgr::addTask("WriteSlot",(TASKENTRY_VOIDPTR)WriteSlot);
    TaskMgr::addTask("ReadSlot",(TASKENTRY_VOIDPTR)ReadSlot);

    TaskMgr::addTask("ReadMemory",(TASKENTRY_VOIDPTR)readMemory);
    TaskMgr::addTask("WriteMemory",(TASKENTRY_VOIDPTR)writeMemory);
